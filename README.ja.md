...
- `diff` サブコマンドで git 差分に含まれるファイルだけを走査
...
```bash
gomut ./internal/gomut --jsonl
gomut ./internal/gomut --jsonl mutations.jsonl
gomut ./internal/gomut --type lived --jsonl
gomut ./internal/gomut --mode all --disable string_literal --jsonl
gomut ./internal/gomut --enable bitwise_operator --disable return --jsonl
gomut ./internal/gomut --jsonl mutations.jsonl --html report.html
```

### HTML 出力

```bash
gomut ./internal/gomut --html
gomut ./internal/gomut --html report.html
gomut ./internal/gomut --jsonl mutations.jsonl --html report.html
```
...
```bash
gomut ./internal/gomut --sarif
gomut ./internal/gomut --sarif gomut.sarif
gomut ./internal/gomut --jsonl mutations.jsonl --sarif gomut.sarif
```
...
- `--exclude` で mutation 生成前に除外するファイルパターンを追加する
